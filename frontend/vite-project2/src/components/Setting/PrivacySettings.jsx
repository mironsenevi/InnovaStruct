      ...
      <div className="space-y-4">
        ...
        <div className="space-y-3">
          <div className="flex items-center justify-between">
            <div>
              <h3 className="text-sm font-medium text-gray-700">Show Email</h3>
              <p className="text-sm text-gray-500">Allow companies to see your email</p>
            </div>
            <button
              type="button"
              className={`${
          ...
          <div className="flex items-center justify-between">
            <div>
              <h3 className="text-sm font-medium text-gray-700">Show Phone Number</h3>
              <p className="text-sm text-gray-500">Allow companies to see your phone number</p>
            </div>
            <button
              type="button"
              className={`${
