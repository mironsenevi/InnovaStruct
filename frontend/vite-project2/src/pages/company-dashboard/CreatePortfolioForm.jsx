  ...
  const renderCompanyDetails = () => (
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div>
          <label className="block text-sm font-medium text-gray-700">CIDA Grading</label>
          <select
            name="cidaGrading"
        ...
        <div>
          <label className="block text-sm font-medium text-gray-700">Engineer Capacity</label>
              ...
              <div className="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-md hover:border-yellow-500 transition-colors">
                <div className="space-y-1 text-center">
                  ...
                  <div className="flex text-sm text-gray-600">
                    <label htmlFor={`certificate-${index}`} className="relative cursor-pointer bg-white rounded-md font-medium text-yellow-600 hover:text-yellow-500 focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-yellow-500">
  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      <div className="flex items-center mb-8">
        ...
        <h1 className="text-2xl font-bold text-gray-900">Create Company Portfolio</h1>
      </div>
          ...
          {steps.map(step => (
            ...
            >
              <div className={`w-8 h-8 rounded-full flex items-center justify-center border-2 ${
                step.number === activeStep ? 'border-yellow-500 bg-yellow-50' : 'border-gray-300'
              }`}>
                {step.number}
              </div>
