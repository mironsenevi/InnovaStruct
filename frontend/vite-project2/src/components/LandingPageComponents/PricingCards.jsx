const PricingCards = () => {
  return (
    <>
      <div
        id="pricing"
        className="font-Raleway bg-yellow-400  min-h-screen py-12 flex flex-col items-center justify-center"
      >
        <div className="mx-auto max-w-screen-sm text-center mb-8 lg:mb-6">
          <h2 className="mb-8 text-8xl tracking-tight font-Raleway text-black">
            Our Pricing
          </h2>
          <p className="font-light text-black lg:mb-6 sm:text-xl px-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          <div className="bg-gray-800 rounded-lg overflow-hidden shadow-md transition-transform transform hover:scale-105 sm:max-w-sm">
            ...
            <div className="p-8">
              ...
              <p className="text-primary mb-6">Ideal for small contractors & individual builders</p>
          ...
          <div className="bg-gray-800 rounded-lg overflow-hidden shadow-md transition-transform transform hover:scale-105 sm:max-w-sm">
            ...
            <div className="p-8">
              ...
              <p className="text-primary mb-6">For large-scale construction companies</p>
