...
function ClientNavbar() {
  return (
    <nav className="fixed top-0 left-0 h-full w-0 sm:w-64 bg-yellow-400 text-yellow-900 overflow-hidden transition-all duration-300 z-50">
      <div className="px-6 py-4 border-b border-yellow-300">
        ...
        <h2 className="text-2xl font-bold text-yellow-900" >InnovaStruct</h2>
        </div>
      </div>
      <ul className="flex flex-col p-4 space-y-4">
        ...
        <li>
        <Link to="/client/settings" className="flex items-center gap-3 p-2 hover:bg-white hover:text-black rounded-lg transition-colors">
